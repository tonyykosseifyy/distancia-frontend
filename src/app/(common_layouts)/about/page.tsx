    ...
    <div className="container">
      ...
      <div className="row g-4 mt-0 mt-lg-5">
        ...
        <div className="col-6 col-md-4 position-relative">
          ...
          {/* Image */}
          <img className="rounded-4" src="images/about/09.jpg" alt="" />
        </div>
        {/* Right image */}
    ...
    <div className="container">
      ...
      <div className="row align-items-center">
        <div className="col-lg-5 position-relative">
          ...
          {/* Image */}
          <img src="images/about/06.jpg" className="rounded" alt="" />
        </div>
      ...
      <div className="row d-flex justify-content-center">
        ...
        <div className="col-6 col-sm-4 col-lg-2">
          <div className="p-4 grayscale text-center">
            <img src="images/client/microsoft.svg" alt="" />
          </div>
        </div>
        {/* Logo item */}
        <div className="col-6 col-sm-4 col-lg-2">
          <div className="p-4 grayscale text-center">
            <img src="images/client/linkedin.svg" alt="" />
          </div>
        </div>
        {/* Logo item */}
        <div className="col-6 col-sm-4 col-lg-2">
          <div className="p-4 grayscale text-center">
            <img src="images/client/netflix.svg" alt="" />
          </div>
        </div>
        {/* Logo item */}
        <div className="col-6 col-sm-4 col-lg-2">
          <div className="p-4 grayscale text-center">
            <img src="images/client/coca-cola.svg" alt="" />
          </div>
        </div>
        {/* Logo item */}
        <div className="col-6 col-sm-4 col-lg-2">
          <div className="p-4 grayscale text-center">
            <img src="images/client/envato.svg" alt="" />
          </div>
        </div>
        {/* Logo item */}
        <div className="col-6 col-sm-4 col-lg-2">
          <div className="p-4 grayscale text-center">
            <img src="images/client/android.svg" alt="" />
          </div>
        </div>
        {/* Logo item */}
        <div className="col-6 col-sm-4 col-lg-2">
        ...
        <div className="col-6 col-sm-4 col-lg-2">
          <div className="p-4 grayscale text-center">
            <img src="images/client/shippable.svg" alt="" />
          </div>
        </div>
        {/* Logo item */}
        <div className="col-6 col-sm-4 col-lg-2">
          <div className="p-4 grayscale text-center">
            <img src="images/client/algolia.svg" alt="" />
          </div>
        </div>
        {/* Logo item */}
        <div className="col-6 col-sm-4 col-lg-2">
          <div className="p-4 grayscale text-center">
            <img src="images/client/importio.svg" alt="" />
          </div>
        </div>
        {/* Logo item */}
        <div className="col-6 col-sm-4 col-lg-2">
          <div className="p-4 grayscale text-center">
            <img src="images/client/yamaha.svg" alt="" />
          </div>
        </div>
      </div>
    </div>
